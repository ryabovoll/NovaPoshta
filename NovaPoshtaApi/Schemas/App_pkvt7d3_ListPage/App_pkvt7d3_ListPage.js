define("App_pkvt7d3_ListPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			{
				...
				"values": {
					"clicked": {
						"request": "crt.CreateAndOpenRecord"
					},
					...
					"columns": [
						{
							...
							"code": "PDS_ARVName",
							"caption": "#ResourceString(PDS_ARVName)#",
							"dataValueType": 1
						},
						{
			...
			},
			{
				...
				"values": {
					...
					"rootSchemaName": "ARVNovaPoshtaDeparture",
					"layoutConfig": {
						"width": 328.125
					},
					"classes": [
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					const result = await handlerChain.process({
						...
						processName: "ARVProcess_6a96c9e",
					...
					if (result.success) {
						const newRecordId = result.resultParameterValues.ID;
						// 3. Открываем созданную запись в режиме редактирования
						await handlerChain.process({
							type: "crt.UpdateRecordRequest",
							entityName: "ARVNovaPoshtaDeparture",
							$context: request.$context,
							recordId: newRecordId
						});
					} else {
						Terrasoft.showInformation("Ошибка при создании записи.");
					}
